...
public class RegistrarSalida extends JPanel{
	...
	public RegistrarSalida()
	{
		...
		Window w = SwingUtilities.getWindowAncestor(RegistrarSalida.this);
	       w.setVisible(false);
			}
		}
		);
		...
		boton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent evento)
			{
				System.out.println("Aqui se registra la hora de salida del auto");
				String x= folioText.getText();
				System.out.println(x);
				Boleto nuevoBoleto= new Boleto(x);
				Boleto folio = new Boleto(x);
				//nuevoBoleto.cobrarBoleto();
				//Estacionamiento.registrarSalida(x);
				
				mensajeSalida.setText(Estacionamiento.registrarSalida(x));
